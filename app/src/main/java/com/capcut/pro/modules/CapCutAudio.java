...
public class CapCutAudio {
    private static final String TAG = "CapCutAudio";
    ...
    public CapCutAudio(Context context) {
    ...
    public void startRecording(AudioRecordingCallback callback) {
        try {
            ...
            if (music != null && !music.exists()) music.mkdirs();
            ...
            if (callback != null) callback.onRecordingStarted(audioFile.getAbsolutePath());
        } catch (Exception e) {
    ...
    public void stopRecording(AudioRecordingCallback callback) {
        try {
            if (recorder != null && isRecording) {
                ...
                if (callback != null) callback.onRecordingStopped(audioFile.getAbsolutePath());
            } else {
    ...
    public String getCurrentAudioPath() { return audioFile != null ? audioFile.getAbsolutePath() : null; }
}